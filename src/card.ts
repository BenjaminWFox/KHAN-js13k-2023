...
export const basicCards: Array<CardConstructorData> = [
  ...
  ['Basic Shield', CARD_TYPE.defense, { d: 8, c: 1, flavor: 'Discretion is the better part of valor, after all.' }],
  ...
  ['Rally Cry', CARD_TYPE.ability, { c: 2, f: 2, d: 12, flavor: 'Such were the regrouping tactics that enemies could find nowhere to strike.' }],
  ['Tactical Retreat', CARD_TYPE.assault, { c: 2, d: 15, draw: 1, flavor: '' }],
...
export const cards: Array<CardConstructorData> = [
  ...
  ['Push Through', CARD_TYPE.assault, { c: 1, draw: 3, flavor: 'Any obstacle may be overcome with enough force.' }],
  ['Clairvoyance', CARD_TYPE.assault, { c: 0, draw: 2, flavor: 'The Khan had a preternatural ability to know what to do next.' }],

  ['Shield Wall', CARD_TYPE.assault, { c: 2, d: 25, flavor: '' }],
  ['Reluctant Withdrawl', CARD_TYPE.assault, { c: 1, d: 12, e: 4, flavor: 'The Khan grew more determined with every forced step backwards.' }],

  ['Whirling Dervish', CARD_TYPE.assault, { c: 2, aa: 10, fa: 2, flavor: 'The Persians were a magnificent addition to the Khan\'s army.' }],
  ['Wrath Of Khan', CARD_TYPE.assault, { c: 3, aa: 15, e: 4, hp: -8, flavor: 'The Khan was merciless, sometimes reckless, in pursuit of his enemies.' }],
  ...
  ['Overpower', CARD_TYPE.assault, { c: 2, a: 18, w: 2, flavor: 'Let your plans be dark and impenetrable as night, and when you move, fall like a thunderbolt.' }],

  ['Shock and Awe', CARD_TYPE.ability, { c: 2, e: 3, w: 3, f: 3, flavor: 'Supreme excellence consists of breaking the enemy\'s resistance without fighting.' }],

  ['Combat Medics', CARD_TYPE.ability, { c: 1, d: 8, hp: 4, flavor: 'A little ginsing and a biiiig shield and you\'ll be back up in no time.' }],
...
export const innateCards: Array<CardConstructorData> = [
  ...
  ['Fearsome Reputation', CARD_TYPE.innate, { on: ACTIVATION_TRIGGER.round, c: 0, w: 5, f: 5, flavor: 'Supreme excellence consists of breaking the enemy\'s resistance without fighting.' }],
