...
export const cards: Array<CardConstructorData> = [
  ...
  ['Clairvoyance', CARD_TYPE.ability, { c: 0, draw: 2, flavor: 'The Khan had a preternatural ability with strategy, to know what to do next.' }],

  ['Shield Wall', CARD_TYPE.defense, { c: 3, d: 30, e: 2, flavor: '' }],
  ['Reluctant Withdrawl', CARD_TYPE.defense, { c: 1, d: 12, e: 3, flavor: 'The Khan grew more determined, and more angry, with every forced step backwards.' }],
