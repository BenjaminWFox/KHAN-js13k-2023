...
export const basicCards: Array<CardConstructorData> = [
  ...
  ['Rally Cry', CARD_TYPE.ability, { c: 2, d: 12, flavor: 'Such were the regrouping tactics that enemies could find nowhere to strike.' }],
...
export const cards: Array<CardConstructorData> = [
  ...
  ['Combat Medics', CARD_TYPE.ability, { c: 1, d: 8, hp: 4, flavor: 'A little ginsing, some water, a BIG shield and you\'ll be back up in no time.' }],
